...
export class DataSupplierAdd extends Component {
  static propTypes = {
  ...
  handleSubmit({ name, code }) {
    ...
    actions.createDataSupplier({ name, code });
  ...
  render() {
    ...
    return (
      <Layout
        pageTitle="Add Data Supplier - Dashboard"
        header="Data Suppliers &gt; Add Data Supplier"
